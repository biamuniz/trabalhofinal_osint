...
* **Youtube**: Com o YouTube Datatool e YouTube Geofind, pesquisamos vídeos com a query `oxigênio manaus` e vídeos georreferenciados em um período específico. Mais detalhes, [aqui]
